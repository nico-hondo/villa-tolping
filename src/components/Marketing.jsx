    ...
    return (
        <section className="max-w-full mx-auto bg-sectionColor justify-center items-center text-center py-12 px-4">
            <div className="text-center max-w-3xl mx-auto">
                <h2 className="font-villatolping font-medium text-white text-3xl md:text-4xl mb-4">{marketing.title}</h2>
                <p className="marketing-description text-gray-400 font-roboto text-sm mb-10">
                    {marketing.subtitle}
                </p>
                <a href={whatsappLinkCSfirst} className="marketing-cta inline-block bg-(--color-button) text-gray-700 font-semibold font-roboto text-sm px-8 py-3 rounded-full hover:bg-gray-900 hover:text-gray-300 transition duration-500">
                    {marketing.cta}
                </a>
            </div>
        </section>
